...
WebTablet = function (url, width, dpi, hand, location, visible) {
    ...
    var tabletProperties = {
        ...
        //   parentID: MyAvatar.SELF_ID,  // CPM comment out
        visible: visible,
        isGroupCulled: true
    };

    if (FIX_TABLET_IN_SPACE) tabletProperties.parentID = MyAvatar.SELF_ID;
    ...
    this.webOverlayID = Overlays.addOverlay("web3d", {
        ...
        alpha: 1.0,
        parentID: this.tabletEntityID,  // CPM parent the overlay to the tablet
        parentJointIndex: -1,
...
WebTablet.prototype.calculateWorldAttitudeRelativeToCamera = function (windowPos) {
    ...
    var clipMousePosition = {
        x: (2 * windowPos.x / Window.innerWidth) - 1,
...
// CPM Hey is this where the tablet lag problem is from?  What controls the refresh rate?
// compute position, rotation & parentJointIndex of the tablet

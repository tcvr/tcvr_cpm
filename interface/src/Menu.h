...
// CPM Menu items text definitions
namespace MenuOption {
    ...
    const QString RenderMaxTextureMemory = "Maximum Texture Memory";   // CPM
    const QString RenderMaxTextureAutomatic = "Automatic Texture Memory"; // CPM Texture Memory

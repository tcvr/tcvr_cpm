...
public:
    ...
    */
    ...
    AttachmentData loadAttachmentData(const QUrl& modelURL, const QUrl& modelURL_LOD1, const QUrl& modelURL_LOD2, const QUrl& modelURL_LOD3, const QString& jointName = QString()) const;
...
private:
    ...
    bool findAvatarEntity_LOD(const QString& modelURL,

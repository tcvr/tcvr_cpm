...
#else
const float LOD_DEFAULT_QUALITY_LEVEL = 0.5f; // CPM DEFAULT LOD QUALITY 0.5 default quality level setting is Mid
#endif
const float LOD_MAX_LIKELY_DESKTOP_FPS = 120.0f; // CPM this is essentially, V-synch fps
#ifdef Q_OS_ANDROID
...
class LODManager : public QObject, public Dependency {
    Q_OBJECT
        ...
        Q_PROPERTY(bool automaticLODAdjust READ getAutomaticLODAdjust WRITE setAutomaticLODAdjust NOTIFY autoLODChanged) // CPM A property change that can notify an object in QML I believe
...
public:
     ...
     */
    Q_INVOKABLE void setBoundaryLevelAdjust(int boundaryLevelAdjust); // CPM Q_INVOKABLE means it can be invoked by QML

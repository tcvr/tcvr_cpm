...
public:
    ...
    // CPM TODO - Add the version number automatically rather than hardcoded. duh.
    QString appTitleString = "Tivoli Cloud VR 1.0.82.1"; // CPM - Added appTitleString variable.  Title used to be hardcoded. 
...
private:
    ...
    bool _developerMenuVisible{ true }; // CPM forced to true so developer menu is always visible

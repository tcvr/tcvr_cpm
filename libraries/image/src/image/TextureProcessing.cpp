...
// CPM THIS CODE CHANGES THE DOWNSAMPLING OF THE IMAGES! YAY.  CHANGED SPARSE PAGE SIZE TO 512 FIXED IT
static const glm::uvec2 SPARSE_PAGE_SIZE(512);  // CPM 128 to 512
static const glm::uvec2 MAX_TEXTURE_SIZE_GLES(8192);  // CPM 2048 to 8192
static const glm::uvec2 MAX_TEXTURE_SIZE_GL(8192); // 4096 to 8192
...
namespace image {
    ...
    // CPM this code does the downsampling grr. 

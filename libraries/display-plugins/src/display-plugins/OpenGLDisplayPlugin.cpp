...
public:
    ...
    // CPM PresentThread is one of the first things called when the quit process begins.  Let's see if we can figure out what calls it :)
    PresentThread() {
    ...
    void shutdown() {
        qCDebug(displayPlugins) << "CPM - Shutdown called in OpenGLDisplayPlugin";

...
const QString ModelEntityItem::DEFAULT_MODEL_URL_LOD1 = QString("");
const QString ModelEntityItem::DEFAULT_MODEL_URL_LOD2 = QString("");
const QString ModelEntityItem::DEFAULT_MODEL_URL_LOD3 = QString("");
...
int ModelEntityItem::readEntitySubclassDataFromBuffer(const unsigned char* data, int bytesLeftToRead,
    ...
    READ_ENTITY_PROPERTY(PROP_MODEL_URL_LOD1, QString, setModelURL_LOD1);  // CPM
    READ_ENTITY_PROPERTY(PROP_MODEL_URL_LOD2, QString, setModelURL_LOD2);  // CPM
    READ_ENTITY_PROPERTY(PROP_MODEL_URL_LOD3, QString, setModelURL_LOD3);  // CPM
...
EntityPropertyFlags ModelEntityItem::getEntityProperties(EncodeBitstreamParams& params) const {
    ...
    requestedProperties += PROP_MODEL_URL_LOD1;
    requestedProperties += PROP_MODEL_URL_LOD2;
    requestedProperties += PROP_MODEL_URL_LOD3;
...
void ModelEntityItem::appendSubclassData(OctreePacketData* packetData, EncodeBitstreamParams& params,
    ...
    APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD1, getModelURL_LOD1());  // CPM
    APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD2, getModelURL_LOD2());  // CPM
    APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD3, getModelURL_LOD3());  // CPM
...
void ModelEntityItem::debugDump() const {
    ...
    qCDebug(entities) << "    model URL LOD1:" << getModelURL();
    qCDebug(entities) << "    model URL LOD2:" << getModelURL();
    qCDebug(entities) << "    model URL LOD3:" << getModelURL();
...
void ModelEntityItem::setModelURL_LOD1(const QString& url) {
    withWriteLock([&] {
        if (_modelURL_LOD1 != url) {
            _modelURL_LOD1 = url;
            if (_shapeType == SHAPE_TYPE_STATIC_MESH) {
                _flags |= Simulation::DIRTY_SHAPE | Simulation::DIRTY_MASS;
            }
...
void ModelEntityItem::setModelURL_LOD2(const QString& url) {
    withWriteLock([&] {
        if (_modelURL_LOD2 != url) {
            _modelURL_LOD2 = url;
            if (_shapeType == SHAPE_TYPE_STATIC_MESH) {
                _flags |= Simulation::DIRTY_SHAPE | Simulation::DIRTY_MASS;
            }
...
void ModelEntityItem::setModelURL_LOD3(const QString& url) {
    withWriteLock([&] {
        if (_modelURL_LOD3 != url) {
            _modelURL_LOD3 = url;
            if (_shapeType == SHAPE_TYPE_STATIC_MESH) {
                _flags |= Simulation::DIRTY_SHAPE | Simulation::DIRTY_MASS;
            }
...
QString ModelEntityItem::getModelURL_LOD1() const {  // CPM
    return resultWithReadLock<QString>([&] {
        return _modelURL_LOD1;
    });
}
QString ModelEntityItem::getModelURL_LOD2() const {  // CPM
    return resultWithReadLock<QString>([&] {
        return _modelURL_LOD2;
    });
}
QString ModelEntityItem::getModelURL_LOD3() const {  // CPM
    return resultWithReadLock<QString>([&] {
        return _modelURL_LOD3;
    });
}

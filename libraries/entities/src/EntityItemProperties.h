...
public:
    ...
    DEFINE_PROPERTY_REF(PROP_MODEL_URL_LOD1, ModelURL_LOD1, modelURL_LOD1, QString, "");
    DEFINE_PROPERTY_REF(PROP_MODEL_URL_LOD2, ModelURL_LOD2, modelURL_LOD2, QString, "");
    DEFINE_PROPERTY_REF(PROP_MODEL_URL_LOD3, ModelURL_LOD3, modelURL_LOD3, QString, "");
...
inline QDebug operator<<(QDebug debug, const EntityItemProperties& properties) {
    ...
    DEBUG_PROPERTY_IF_CHANGED(debug, properties, ModelURL_LOD1, modelURL_LOD1, "");  // CPM
    DEBUG_PROPERTY_IF_CHANGED(debug, properties, ModelURL_LOD2, modelURL_LOD2, "");  // CPM
    DEBUG_PROPERTY_IF_CHANGED(debug, properties, ModelURL_LOD3, modelURL_LOD3, "");  // CPM

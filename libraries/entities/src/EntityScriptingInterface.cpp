...
QUuid EntityScriptingInterface::addModelEntity(const QString& name, const QString& modelUrl, const QString& textures,
    ...
    //properties.setModelURL_LOD1(modelUrl_LOD1);  // CPM
    //properties.setModelURL_LOD2(modelUrl_LOD2);  // CPM
    //properties.setModelURL_LOD3(modelUrl_LOD3);  // CPM
...
// CPM OVERRIDE WITH MULTIPLE MODELS FOR LOD
QUuid EntityScriptingInterface::addModelEntity_LOD(const QString& name, const QString& modelUrl, const QString& modelUrl_LOD1, const QString& modelUrl_LOD2, const QString& modelUrl_LOD3,
    const QString& textures, const QString& shapeType, bool dynamic, bool collisionless, bool grabbable, const glm::vec3& position, const glm::vec3& gravity) {
    _activityTracking.addedEntityCount++;

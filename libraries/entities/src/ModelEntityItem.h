...
public:
    ...
    static const QString DEFAULT_MODEL_URL_LOD1;
    static const QString DEFAULT_MODEL_URL_LOD2;
    static const QString DEFAULT_MODEL_URL_LOD3;

    QString getModelURL() const;
    QString getModelURL_LOD1() const;  // CPM
    QString getModelURL_LOD2() const;  // CPM
    QString getModelURL_LOD3() const;  // CPM
    ...
    virtual void setModelURL_LOD1(const QString& url);  // CPM
    virtual void setModelURL_LOD2(const QString& url);  // CPM
    virtual void setModelURL_LOD3(const QString& url);  // CPM
...
protected:
    ...
    QString _modelURL;
    QString _modelURL_LOD1;  // CPM
    QString _modelURL_LOD2;  // CPM
    QString _modelURL_LOD3;  // CPM

...
void EntityItemProperties::debugDump() const {
    ...
    qCDebug(entities) << "   _modelURL_LOD1=" << _modelURL_LOD1;
    qCDebug(entities) << "   _modelURL_LOD2=" << _modelURL_LOD2;
    qCDebug(entities) << "   _modelURL_LOD3=" << _modelURL_LOD3;
...
EntityPropertyFlags EntityItemProperties::getChangedProperties() const {
    ...
    CHECK_PROPERTY_CHANGE(PROP_MODEL_URL_LOD1, modelURL_LOD1);
    CHECK_PROPERTY_CHANGE(PROP_MODEL_URL_LOD2, modelURL_LOD2);
    CHECK_PROPERTY_CHANGE(PROP_MODEL_URL_LOD3, modelURL_LOD3);
...
QScriptValue EntityItemProperties::copyToScriptValue(QScriptEngine* engine, bool skipDefaults, bool allowUnknownCreateTime,
    ...
    if (_type == EntityTypes::Model) {
        ...
        COPY_PROPERTY_TO_QSCRIPTVALUE(PROP_MODEL_URL_LOD1, modelURL_LOD1);
        COPY_PROPERTY_TO_QSCRIPTVALUE(PROP_MODEL_URL_LOD2, modelURL_LOD2);
        COPY_PROPERTY_TO_QSCRIPTVALUE(PROP_MODEL_URL_LOD3, modelURL_LOD3);
...
void EntityItemProperties::copyFromScriptValue(const QScriptValue& object, bool honorReadOnly) {
    ...
    COPY_PROPERTY_FROM_QSCRIPTVALUE(modelURL_LOD1, QString, setModelURL_LOD1);  // CPM
    COPY_PROPERTY_FROM_QSCRIPTVALUE(modelURL_LOD2, QString, setModelURL_LOD2);  // CPM
    COPY_PROPERTY_FROM_QSCRIPTVALUE(modelURL_LOD3, QString, setModelURL_LOD3);  // CPM
...
void EntityItemProperties::merge(const EntityItemProperties& other) {
    ...
    COPY_PROPERTY_IF_CHANGED(modelURL_LOD1);
    COPY_PROPERTY_IF_CHANGED(modelURL_LOD2);
    COPY_PROPERTY_IF_CHANGED(modelURL_LOD3);
...
bool EntityItemProperties::getPropertyInfo(const QString& propertyName, EntityPropertyInfo& propertyInfo) {
    ...
    std::call_once(initMap, []() {
        ...
        ADD_PROPERTY_TO_MAP(PROP_MODEL_URL, ModelURL_LOD1, modelURL_LOD1, QString);
        ADD_PROPERTY_TO_MAP(PROP_MODEL_URL, ModelURL_LOD2, modelURL_LOD2, QString);
        ADD_PROPERTY_TO_MAP(PROP_MODEL_URL, ModelURL_LOD3, modelURL_LOD3, QString);
    ...
    if (success) {
        ...
        if (headerFits) {
            ...
            if (properties.getType() == EntityTypes::Model) {
                ...
                APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD1, properties.getModelURL_LOD1());  // CPM
                APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD2, properties.getModelURL_LOD2());  // CPM
                APPEND_ENTITY_PROPERTY(PROP_MODEL_URL_LOD3, properties.getModelURL_LOD3());  // CPM
...
bool EntityItemProperties::decodeEntityEditPacket(const unsigned char* data, int bytesToRead, int& processedBytes,
    ...
    if (properties.getType() == EntityTypes::Model) {
        ...
        READ_ENTITY_PROPERTY_TO_PROPERTIES(PROP_MODEL_URL_LOD1, QString, setModelURL_LOD1);  // CPM
        READ_ENTITY_PROPERTY_TO_PROPERTIES(PROP_MODEL_URL_LOD2, QString, setModelURL_LOD2);  // CPM
        READ_ENTITY_PROPERTY_TO_PROPERTIES(PROP_MODEL_URL_LOD3, QString, setModelURL_LOD3);  // CPM
...
void EntityItemProperties::markAllChanged() {
    ...
    _modelURL_LOD1Changed = true; // CPM
    _modelURL_LOD2Changed = true; // CPM
    _modelURL_LOD3Changed = true; // CPM
...
QList<QString> EntityItemProperties::listChangedProperties() {
    ...
    // CPM
    if (modelURL_LOD1Changed()) {
        out += "modelURL_LOD1";
    }

    // CPM
    if (modelURL_LOD2Changed()) {
        out += "modelURL_LOD2";
    }

    // CPM
    if (modelURL_LOD3Changed()) {
        out += "modelURL_LOD3";
    }
...
QByteArray EntityItemProperties::getStaticCertificateJSON() const {
    ...
    ADD_STRING_PROPERTY(modelURL_LOD1, ModelURL_LOD1);
    ADD_STRING_PROPERTY(modelURL_LOD2, ModelURL_LOD2);
    ADD_STRING_PROPERTY(modelURL_LOD3, ModelURL_LOD3);

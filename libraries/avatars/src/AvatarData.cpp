...
void AttachmentDataObject::setModelURL_LOD1(const QString& modelURL) {
    AttachmentData data = qscriptvalue_cast<AttachmentData>(thisObject());
    data.modelURL_LOD1 = modelURL;
    thisObject() = engine()->toScriptValue(data);
}

void AttachmentDataObject::setModelURL_LOD2(const QString& modelURL) {
    AttachmentData data = qscriptvalue_cast<AttachmentData>(thisObject());
    data.modelURL_LOD2 = modelURL;
    thisObject() = engine()->toScriptValue(data);
}

void AttachmentDataObject::setModelURL_LOD3(const QString& modelURL) {
    AttachmentData data = qscriptvalue_cast<AttachmentData>(thisObject());
    data.modelURL_LOD3 = modelURL;
    thisObject() = engine()->toScriptValue(data);
}
...
QString AttachmentDataObject::getModelURL_LOD1() const {
    return qscriptvalue_cast<AttachmentData>(thisObject()).modelURL.toString();
}

QString AttachmentDataObject::getModelURL_LOD2() const {
    return qscriptvalue_cast<AttachmentData>(thisObject()).modelURL.toString();
}

QString AttachmentDataObject::getModelURL_LOD3() const {
    return qscriptvalue_cast<AttachmentData>(thisObject()).modelURL.toString();
}

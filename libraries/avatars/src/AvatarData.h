...
class AttachmentDataObject : public QObject, protected QScriptable {
    ...
    Q_PROPERTY(QString modelURL_LOD1 READ getModelURL_LOD1 WRITE setModelURL_LOD1)  // CPM
    Q_PROPERTY(QString modelURL_LOD2 READ getModelURL_LOD2 WRITE setModelURL_LOD2)  // CPM
    Q_PROPERTY(QString modelURL_LOD3 READ getModelURL_LOD3 WRITE setModelURL_LOD3)  // CPM
...
public:
    ...
    Q_INVOKABLE void setModelURL_LOD1(const QString& modelURL);  // CPM
    Q_INVOKABLE void setModelURL_LOD2(const QString& modelURL);  // CPM
    Q_INVOKABLE void setModelURL_LOD3(const QString& modelURL);  // CPM

    Q_INVOKABLE QString getModelURL() const;
    Q_INVOKABLE QString getModelURL_LOD1() const;  // CPM
    Q_INVOKABLE QString getModelURL_LOD2() const;  // CPM
    Q_INVOKABLE QString getModelURL_LOD3() const;  // CPM
